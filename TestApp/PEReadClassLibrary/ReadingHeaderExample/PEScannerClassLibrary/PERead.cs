...
namespace ReadingHeaderExample
{
 ...
 out long lpNewFilePointer, uint dwMoveMethod);
    ...
    public class ImportFunctionObject
    {
        public string function;
        public UInt32 baseAddress;
        public string dependency;
        public ImportFunctionObject(string functionName, UInt32 baseAddress, string dependency)
        {
            this.function = functionName;
   ...
   // getHeader("E:\\project1.exe");
    public abstract class PERead
    {
        ...
        string filePath;
        public PERead(string dependencyName, string filePath)
        {
            ...
            GetHeader(filePath);
            MakeDependencies(filePath);

        }

       static List<PERead> Dependencies = new List<PERead>();
       ...
       static List<HeaderObject> Headers = new List<HeaderObject>();
        ...
        public static List<PERead> MakeDependencies(string path)
        {
            return Dependencies;
        }

        public static List<HeaderObject> GetHeader(string path)
        {
            PeHeaderReader reader = new PeHeaderReader(path);
        ...
        public static List<SectionObject> GetSections(string path)
        {
            PeHeaderReader reader = new PeHeaderReader(path);
        ...
        public static List<DirectoryObject> GetDirectories(string path)
        {
            PeHeaderReader reader = new PeHeaderReader(path);
             unsafe
            {
        ...
        public static List<ImportFunctionObject> LoadImports(string path, bool mappedAsImage)
        {
            PeHeaderReader reader = new PeHeaderReader(path);
        ...
        public static List<FunctionObject> LoadExports(string path, bool mappedAsImage)
        {
            PeHeaderReader reader = new PeHeaderReader(path);
            var hLib = LoadLibraryEx(path, 0,
                               DONT_RESOLVE_DLL_REFERENCES | LOAD_IGNORE_CODE_AUTHZ_LEVEL);
